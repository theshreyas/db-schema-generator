...
function AboutSection() {
  return (
    <div className="container mt-5 aboutSection">
        ...
        <p className="about">If you encounter any issues or have feature suggestions, please create an issue on <a href="https://github.com/theshreyas/db-schema-generator">GitHub</a> repository. And if you liked this tool, please leave a star!</p>
        <div className="about">
          <ul className="task-list">
              ...
              <li><span className="status completed">Completed</span> <p className="complete">Add syntax highlighter, toast notifications</p> 
              </li>
